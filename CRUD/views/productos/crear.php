...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="index.php?action=productos&method=crear">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="tipo_producto" name="tipo_producto" required>
                                        ...
                                        <?php foreach ($tipos as $tipo): ?>
                                            <option value="<?php echo $tipo['id_tipo']; ?>"
                                                    <?php echo (($_POST['tipo_producto'] ?? '') == $tipo['id_tipo']) ? 'selected' : ''; ?>>
                                    ...
                                    <select class="form-select" id="material" name="material" required>
                                        ...
                                        <?php foreach ($opciones_material as $material): ?>
                                            <option value="<?php echo htmlspecialchars($material); ?>"
                                                    <?php echo (($_POST['material'] ?? '') == $material) ? 'selected' : ''; ?>>
